...
export default {
  getPMSList: function(rgb, distance) {
    ...
    for (var i = 0; i < rgbArray.length; i++) {
      const rgb1 = rgbArray[i];
      const r1 = parseInt(rgb1[0] + rgb1[1], 16);
      const g1 = parseInt(rgb1[2] + rgb1[3], 16);
      const b1 = parseInt(rgb1[4] + rgb1[5], 16);
      aDisVal[i] = Math.sqrt(
        Math.pow(r - r1, 2) + Math.pow(g - g1, 2) + Math.pow(b - b1, 2)
      );
    }
    for (i = 0; i < aDisVal.length; i++) {
